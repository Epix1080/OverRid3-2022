...
genderProto = "app/gender_deploy.prototxt"
genderModel = "app/gender_net.caffemodel"
ageProto = "app/age_deploy.prototxt"
ageModel = "app/age_net.caffemodel"
...
def maindet():
    ...
    while True:
        ...
        label = "{}, {}".format(g,a)
        cv2.putText(img,label,(0,20), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 3, cv2.LINE_AA)
